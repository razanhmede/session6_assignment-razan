...
static const _CheckStock_Request_type_support_symbol_names_t _CheckStock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customized_interfaces, srv, CheckStock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customized_interfaces, srv, CheckStock_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, customized_interfaces, srv, CheckStock_Request)() {
  return &::customized_interfaces::srv::rosidl_typesupport_c::CheckStock_Request_message_type_support_handle;
}
...
static const _CheckStock_Response_type_support_symbol_names_t _CheckStock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customized_interfaces, srv, CheckStock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customized_interfaces, srv, CheckStock_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, customized_interfaces, srv, CheckStock_Response)() {
  return &::customized_interfaces::srv::rosidl_typesupport_c::CheckStock_Response_message_type_support_handle;
}
...
static const _CheckStock_type_support_symbol_names_t _CheckStock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customized_interfaces, srv, CheckStock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customized_interfaces, srv, CheckStock)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, customized_interfaces, srv, CheckStock)() {
  return &::customized_interfaces::srv::rosidl_typesupport_c::CheckStock_service_type_support_handle;
}
