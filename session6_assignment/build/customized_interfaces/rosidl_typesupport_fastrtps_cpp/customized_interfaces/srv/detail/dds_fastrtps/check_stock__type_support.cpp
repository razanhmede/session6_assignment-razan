...
#include "customized_interfaces/srv/detail/check_stock__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = customized_interfaces::srv::CheckStock_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const customized_interfaces::srv::CheckStock_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<customized_interfaces::srv::CheckStock_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CheckStock_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const customized_interfaces::srv::CheckStock_Request *>(
...
static size_t _CheckStock_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CheckStock_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CheckStock_Request__callbacks = {
...
static rosidl_message_type_support_t _CheckStock_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CheckStock_Request__callbacks,
...
{
  return &customized_interfaces::srv::typesupport_fastrtps_cpp::_CheckStock_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = customized_interfaces::srv::CheckStock_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const customized_interfaces::srv::CheckStock_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<customized_interfaces::srv::CheckStock_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CheckStock_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const customized_interfaces::srv::CheckStock_Response *>(
...
static size_t _CheckStock_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CheckStock_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CheckStock_Response__callbacks = {
  "customized_interfaces::srv",
  "CheckStock_Response",
...
static rosidl_message_type_support_t _CheckStock_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CheckStock_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &customized_interfaces::srv::typesupport_fastrtps_cpp::_CheckStock_Response__handle;
}
...
static service_type_support_callbacks_t _CheckStock__callbacks = {
  "customized_interfaces::srv",
  "CheckStock",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, customized_interfaces, srv, CheckStock_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, customized_interfaces, srv, CheckStock_Response)(),
...
static rosidl_service_type_support_t _CheckStock__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CheckStock__callbacks,
...
{
  return &customized_interfaces::srv::typesupport_fastrtps_cpp::_CheckStock__handle;
}
